...
export default function Footer() {
  return (
    <footer className="mx-4 md:mx-8 border-t-2 border-dashed border-white/30 border-opacity-60 py-10 relative z-10 mt-16" style={{ borderSpacing: "6px", borderTopWidth: "2px" }}>
