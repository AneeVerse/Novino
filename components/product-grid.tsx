...
export default function ProductGrid({ category = "All Products" }: ProductGridProps) {
      ...
      <div className="flex gap-0.5">
        {[...Array(5)].map((_, i) => (
          <svg 
            ...
            height="16" 
            viewBox="0 0 24 24" 
            fill={(i < Math.floor(rating)) ? "white" : "none"}
            stroke="white" 
            strokeWidth="1.5"
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8" style={{ maxWidth: "100%" }}>
          ...
          <div className="p-5 md:p-6 bg-[#333333]">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex flex-col items-end">
                ...
                <div className="text-white text-[11px] md:text-xs mt-1 text-center font-medium inline-block w-6">
                  {product.rating}
                </div>
              </div>
            </div>
