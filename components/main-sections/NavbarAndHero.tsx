  ...
  return (
    <div className="relative min-h-screen bg-transparent">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        {/* Top-right layered white gradients */}
        <div 
      ...
      <nav className="fixed top-0 left-0 right-0 z-10 border-b border-white/10 overflow-visible">
        <div className="absolute inset-0 bg-[#2D2D2D]/20 backdrop-blur-sm" style={{ zIndex: 1 }}></div>
        ...
        >
          <span className="text-black font-bold">DEBUG</span>
        </div>
        <div className="relative flex items-center justify-between p-4 md:p-6" style={{ zIndex: 3 }}>
