    ...
    <main className="relative min-h-screen bg-[#2D2D2D] overflow-x-hidden">
      ...
      <div className="relative w-full h-[350px]">
        ...
        <div className="absolute inset-0 z-20 overflow-hidden" style={{ height: '350px', maxHeight: '350px' }}>
          ...
          ></div>
          <h1 
            className={`journey-hero-text text-[130px] md:text-[200px] lg:text-[260px] font-dm-serif-display leading-none absolute w-full text-center ${showText ? 'animate-rise-up' : 'invisible opacity-0'}`}
          >
            JOURNEY
          </h1>
        </div>
